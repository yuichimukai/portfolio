...
const articleId: NextPage<Props> = (props: Props) => {
  ...
  return (
    <SideBarLayout>
      ...
      <Meta title={article.title} image={ogpUrl} favicon={article.emoji} />
      <BrowserWindow>
        <ContentSection>
          {!isPublished(article) && (
            <DetailPageAlert>
            ...
            <DetailPageHeader>
              ...
              <DetailPageMetaData>
                ...
                <DetailPageDate>
                  ...
                  <DetailPageDateText>{dateString}</DetailPageDateText>
                </DetailPageDate>
                <DetailPageReadingTime>
...
export const getStaticProps: GetStaticProps<Props, Params> = async (
  ...
  const content: DraftItem | ArticleItem = context.preview
    ? await getDraft(
        articleId,
        (context.previewData as { id: string; draftKey: string }).draftKey
      )
